...
<script src="/blog/related.js"></script>
</body>
</html>"""
...
.blog-hero p{{font-size:15px;color:rgba(244,232,208,0.45);max-width:480px;margin:0 auto;line-height:1.65}}
...
<div class="blog-hero">
  <h1>Blog posts</h1>
  <p>take what you'd like and leave the rest! Shoot me a DM if you have questions about any of these posts / want more info</p>
</div>
